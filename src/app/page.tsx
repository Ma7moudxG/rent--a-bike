...
const perks = [
  ...
  },
  {
    name: 'For The Planet', 
    Icon: Leaf,
    description: '1% of our sales to restoration of the nature'
  } 
            ...
            {perks.map((perk) => {
              ...
              className='text-center md:flex md:items-start md:text-left lg:block lg:text-center '>
                <div className='md:flex-shrink-0 flex justify-center'>
                  <div className='w-16 h-16 flex items-center justify-center rounded-full bg-orange-100 text-orange-900'>
