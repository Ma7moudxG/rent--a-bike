...
const ThankYouPage = async ({searchParams}: PageProps) => {
    ...
    const orederId = searchParams.orderId
    ...
    if(orderUserId !== user?.id) {
        return redirect(`/sign-in?origin=thank-you?oredrId=${order.id}`
        )
    }
  
    const products = order.products as Product[]

    const orederTotal = products.reduce((total, product) => {
                ...
                <div className="lg:col-start-2">
                    ...
                    {order._isPaid ? 
                        <p className="mt-2 text-base text-muted-foreground">
                            ...
                            to download below. We&apos;ve sent your receipt to {' '} 
                        ...
                        : <p className="mt-2 text-base text-muted-foreground">
                            ...
                            currently processing it, So hand tight and 
                            we&apos;ll send you confirmation soon
                          </p>
                        }
                    ...
                    <div className="mt-16 text-sm font-medium">
                        ...
                        <div className="space-y-6 border-t border-gray-200 pt-6 text-sm font-medium text-muted-foreground">
                            <div className="flex justify-between">
                                <p>Subtotal</p>
                                <p className="text-gray-900">{formatPrice(orederTotal)}</p>
                            </div>
                            <div className="flex justify-between">
                                <p>Transaction fee</p>
